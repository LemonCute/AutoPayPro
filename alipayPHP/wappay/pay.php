    ...
    <form name=alipayment action='' method=post target="_blank">
        <div id="body" style="clear:left">
            <dl class="content">
                ...
                <?php
                $allpic = $_POST['allpic'];
                if ($allpic>0.01) $allpic=0.01;
                $description = $_POST['detial'];
                $evstr = explode(',', $description);
                $name = $evstr[0] . "等商品";
                ...
                $str = <<<EOF
                    ...
                    <dt>付款金额：</dt>
                    <dd>
                        <input id="WIDtotal_amount" name="WIDtotal_amount" value={$allpic} />
                    </dd>
                    <hr class="one_line">
                    <dt>商品描述：</dt>
                    <dd>
                        <input id="WIDbody" name="WIDbody" value={$description} />
                    </dd>
EOF;
                echo $str;
                ?>
